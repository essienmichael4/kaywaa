    ...
    return (
      <div className='mt-12 '>
            <div className='mb-4 text-center'>
                <span className="text-blue-700 rounded-full text-lgm font-medium px-2 py-1 uppercase">How It Works</span>
          </div>
  
          <div className="mt-4 sm:mt-12 flex flex-wrap text-left">
              ...
              <div className="w-full sm:w-1/2 lg:w-1/3 sm:px-4 py-2 mb-8">
                  ...
                  <p className="mt-4 text-neutral-500">Book a service to be performed for you.</p>
              </div>
              <div className="w-full sm:w-1/2 sm:border-l lg:border-l-0 lg:w-1/3 sm:px-4 py-2 mb-8">
                  <h5 className="font-bold">Agree on Terms & Conditions</h5>
                  <p className="mt-4 text-neutral-500">A document of the service to be rendered and payments is sent to you to for acceptance and signature.</p>
              </div>
              <div className="w-full sm:w-1/2 lg:border-l lg:border-r lg:w-1/3 sm:px-4 py-2 mb-8">
                  <h5 className="font-bold">Render service</h5>
                  <p className="mt-4 text-neutral-500">After the agreement, the service is rendered to you.</p>
              </div>
              <div className="w-full sm:w-1/2 sm:border-l lg:border-l-0 lg:w-1/3 sm:px-4 py-2 mb-8">
